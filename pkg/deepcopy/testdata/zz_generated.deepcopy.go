...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in Bars) DeepCopyInto(out *Bars) {
	{
		in := &in
		*out = make(Bars, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(Bar)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Bars.
func (in Bars) DeepCopy() Bars {
	if in == nil {
		return nil
	}
	out := new(Bars)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MapAlias) DeepCopyInto(out *MapAlias) {
	{
		in := &in
		*out = make(MapAlias, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MapAlias.
func (in MapAlias) DeepCopy() MapAlias {
	if in == nil {
		return nil
	}
	out := new(MapAlias)
...
func (in *SpecificCases) DeepCopyInto(out *SpecificCases) {
	*out = *in
	...
	if in.StringAliasPtr != nil {
		in, out := &in.StringAliasPtr, &out.StringAliasPtr
		*out = new(StringAlias)
		**out = **in
	}
	if in.NestedAliasSlices != nil {
		in, out := &in.NestedAliasSlices, &out.NestedAliasSlices
		*out = new(Bars)
		if **in != nil {
			in, out := *in, *out
			*out = make(Bars, len(*in))
	...
	if in.NestedAliasMaps != nil {
		in, out := &in.NestedAliasMaps, &out.NestedAliasMaps
		*out = new(MapAlias)
		if **in != nil {
			in, out := *in, *out
			*out = make(MapAlias, len(*in))
