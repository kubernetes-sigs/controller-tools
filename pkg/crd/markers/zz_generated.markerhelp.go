...
func (PrintColumn) Help() *markers.DefinitionHelp {
	return &markers.DefinitionHelp{
		...
		DetailedHelp: markers.DetailedHelp{
			...
			Details: "This allows you to customize what columns are shown when users run `kubectl get` on your CRD.\n\nExample:\n\n\t// +kubebuilder:printcolumn:name=\"Status\",type=string,JSONPath=`.status.phase`\n\t// +kubebuilder:printcolumn:name=\"Age\",type=date,JSONPath=`.metadata.creationTimestamp`\n\ttype MyCRD struct {\n\t    metav1.TypeMeta\n\t    metav1.ObjectMeta\n\t}",
		},
		FieldHelp: map[string]markers.DetailedHelp{
			"Name": {
			...
			"Description": {
				...
				Details: "This is shown when using `kubectl get` with the `-o wide` flag.",
			},
			"Format": {
