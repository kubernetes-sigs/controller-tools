...
// +kubebuilder:printcolumn:name="toy",type="string",JSONPath=".status.conditions[?(@.type==\"Ready\")].status",description="descr1"
// +kubebuilder:printcolumn:name="abc",type="string",JSONPath="status",description="descr2"
type Toy struct {
