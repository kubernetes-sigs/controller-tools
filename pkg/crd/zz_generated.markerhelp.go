...
func (Generator) Help() *markers.DefinitionHelp {
	return &markers.DefinitionHelp{
		...
		FieldHelp: map[string]markers.DetailedHelp{
			...
			"SkipToolVersionAnnotation": {
				Summary: "specifies if the controller-gen version annotation",
				Details: "(controller-gen.kubebuilder.io/version) should be skipped when generating the CRD.\n\nLeft unspecified, the default is false.",
			},
		},
	}
}
