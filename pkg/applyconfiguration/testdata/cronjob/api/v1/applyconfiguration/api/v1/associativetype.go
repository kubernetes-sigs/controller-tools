...
// AssociativeTypeApplyConfiguration constructs a declarative configuration of the AssociativeType type for use with
// apply.
func AssociativeType() *AssociativeTypeApplyConfiguration {
	return &AssociativeTypeApplyConfiguration{}
}
func (b AssociativeTypeApplyConfiguration) IsApplyConfiguration() {}
