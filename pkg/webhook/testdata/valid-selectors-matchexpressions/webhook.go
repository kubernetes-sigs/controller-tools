...
// Validating webhook with namespaceSelector (matchExpressions). Uses backticks so no escapes are needed.
...
// Mutating webhook with objectSelector (matchLabels and matchExpressions). Uses backticks so no escapes are needed.
