...
`,
		RunE: func(c *cobra.Command, rawOpts []string) error {
			...
			rt.SkipUnchanged = skipUnchanged
	...
	cmd.Flags().BoolVar(&skipUnchanged, "skip-unchanged", false, "skip writing output files whose content has not meaningfully changed, ignoring version annotations and generated-by comments")
